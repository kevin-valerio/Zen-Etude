							    ...
							    <form action="#" style="margin: 10px;padding: 0; border-top: ridge; border-bottom: ridge;">
							    	<table id="vertical-1" class="striped highlight">
                                        ...
                                        <tr>
                                            ...
                                            <!-- bootbox modal -->
                                            <div class="form-content-mail" style="display:none;">
                                                <form class="form" role="form">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="email">Tapez votre nouveau mail</label>
                                                        <input value="" type="email" class="form-control email" name="email">
                                                    </div>
                                                </form>
                                            </div>
                                        </tr>
							            <tr>
                                            ...
                                            <!-- bootbox modal -->
                                            <div class="form-content-pays" style="display:none;">
                                                <form class="form" role="form">
                                                    <div class="form-group">
                                                        <p><label>Ancien pays:</label></p>
                                                        <span><?= Controller::getMainUser()->getPaysdomicile() ?></span>
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="pays">Selectionnez votre nouveau pays</label>
                                                        <div class="input-field col 12">
                                                            <select class="form-control pays" name="pays">
                                        ...
                                        <tr>
                                            ...
                                            <!-- bootbox modal -->
                                            <div class="form-content-ville" style="display:none;">
                                                <form class="form" role="form">
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input value="" type="text" class="form-control ville" name="ville">
                                                    </div>
                                                </form>
                                            </div>
                                        </tr>
							            ...
							            <tr>
                                            ...
                                            <!-- bootbox modal -->
                                            <div class="form-content-mdp" style="display:none;">
                                                <form class="form" role="form">
                                                    <div class="form-group">
                                                        <label for="oldmdp">Entrez votre encien mot de passe</label>
                                                        <input type="password" class="oldmdp" name="oldmdp">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="newmdp">Entrez votre nouveau mot de passe</label>
                                                        <input value="" type="password" class="form-control newmdp" name="newmdp" placeholder="Nouveau mot de passe">
                                                        <input value="" type="password" class="form-control newmdpverif" name="newmpdverif" placeholder="Verif du mot de passe">
                                                    </div>
                                                </form>
                                            </div>
